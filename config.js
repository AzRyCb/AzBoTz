...
// untuk jualan di store.js
//donasi atau payment cek info-payment.js
//=============『 Utama 』================== //
//(m, { conn, command, usedPrefix })
global.wm = '❋ཻུ۪۪⸙ Whatsapp Botz Multi-Device ❋ཻུ۪۪'
...
global.set = {
  ...
  error: `_*🚨 Fitur ini Sedang Error*_\nHarap laporkan hal ini`,
  wait: '⏳ Tunggu sebentar . . .',
  render: '*ʀᴇɴᴅᴇʀ!*',
  ucapan: ucapan(),
  clockString: clockStringg,
