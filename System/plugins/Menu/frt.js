...
switch (template) {
	...
	return await conn.sendListM(m.chat, bf, be, m)
        ...
        conn.sendButtonVid(m.chat, cc.url, set.wm, 'Nih.mp4', 'To Sticker', '.s', fakes, adReply)
            break
            case 'asupan':
            case 'china':
            case 'hijab':
        ...
        conn.sendButtonVid(m.chat, asu, set.wm, 'Nih.mp4', 'To Sticker', '.s', fakes, adReply)
            break
            case 'ahegao':
case 'anal':
case 'ass':
...
case 'asupan':
        ...
        conn.sendButton(m.chat, 'Nih.jpg', set.wm, nsf, ['To Sticker', '.s'], fakes, adReply)
            break
            case 'pinterest':
...
case 'toxic':
        ...
        conn.sendButton(m.chat, 'Nih.jpg', set.wm, tpr, [['To Sticker', '.s']], fakes, adReply)
            break
            case 'wanted':
