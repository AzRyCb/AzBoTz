...
if (!args[1]) return conn.sendButton(m.chat, '––––––『 SMULE 』––––––', null, null, [['🎥 VIDEO', `${usedPrefix}smule ${args[0]} video`],['🎙️ AUDIO', `${usedPrefix}smule ${args[0]} audio`]], fakes, adReply)
...
*title:* ${x.result.title}
    `, set.wm, 'To mp3', '.tomp3', fakes, adReply)
  }
  if (args[1] == 'audio') {
