...
try {
  ...
  conn.sendButtonVid(m.chat, res.media[x].url, caption, set.wm, 'To mp3', '.tomp3', fakes, adReply)
	}
	} catch {
	try {
...
━━━━━•─────────────── 
       ⇆ㅤ◁ㅤ ❚❚ㅤ ▷ㅤ↻`, set.wm, 'To mp3', '.tomp3', fakes, adReply)
            })
	}
