...
let handler = async (m, { conn, usedPrefix, command, text }) => {
  ...
  try {
	...
	delete db.data.users[user]
 	...
 	conn.sendHydrated(m.chat, anu, set.wm, pp, null,null, number, '🌹 BYE USERS', [[null,null],[null,null],[null,null]], m, {mentions: [number+'@s.whatsapp.net']})
  }
}
