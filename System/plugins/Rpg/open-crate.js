    ...
    switch (type) {
        case 'common':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastime = (new Date - user.lastopen)
                    let _lastime = (30000 - __lastime) 
                    let lastime = clockString(_lastime)
                    if (new Date - user.lastopen > 30000) {
...
`.trim()
                ...
                break
                case '10':
                    let __lastimeq = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimeqq = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimeqqq = (new Date - user.lastopen)
...
`.trim()
        ...
        case 'uncommon':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimew = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '10':
                    let __lastimewe = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimewee = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimeweee = (new Date - user.lastopen)
...
`.trim()
        ...
        case 'mythic':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimep = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '10':
                    let __lastimepa = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '100':
                    let __lastimepaa = (new Date - user.lastopen)
...
`.trim()
                ...
                break
                case '1000':
                    let __lastimepaaa = (new Date - user.lastopen)
...
`.trim()
        ...
        case 'boxs':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimed = (new Date - user.lastopen)
...
`.trim()
                    if (user.boxs >= 1) {
                        user.boxs -= 1
                        user.money += mmz * 1
                        user.emasbiasa += ebz * 1
                        user.exp += mez * 1
                        user.potion += mpz * 1
                        user.healtmonster += hmz * 1
                        user.makananpet += lmz * 1
                        user.lastopen = new Date * 1
                ...
                break
                case '10': 
                    let __lastimedo = (new Date - user.lastopen)
...
`.trim()
                    if (user.boxs >= 10) {
                        user.boxs -= 10
                        user.money += mme * 1
                        user.emasbiasa += ebe * 1
                        user.exp += mee * 1
                        user.potion += mpe * 1
                        user.healtmonster += hme * 1
                        user.makananpet += lme * 1
                        user.lastopen = new Date * 1
...
`.trim()
                    if (user.boxs >= 100) {
                        user.boxs -= 100
                        user.money += mmk * 1
                        user.emasbiasa += ebk * 1
                        user.exp += mek * 1
                        user.potion += mpk * 1
                        user.healtmonster += hmk * 1
                        user.makananpet += lmk * 1
                        user.lastopen = new Date * 1
...
`.trim()
                    if (user.boxs >= 1000) {
                        user.boxs -= 1000
                        user.money += mmo * 1
                        user.emasbiasa += ebo * 1
                        user.exp += meo * 1
                        user.potion += mpo * 1
                        user.healtmonster += hmo * 1
                        user.makananpet += lmo * 1
                        user.lastopen = new Date * 1
       ...
       case 'gardenboxs':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimedz = (new Date - user.lastopen)
...
`.trim()
                    if (user.gardenboxs >= 0) {
                        user.gardenboxs -= 1
                        user.bibitmangga += alp * 1
                        user.bibitpisang += dlp * 1
                        user.bibitjeruk += clp * 1
                        user.bibitapel += blp * 1
                        user.bibitanggur += elp * 1
                        user.lastopen = new Date * 1
                ...
                case '10':
                case 'crate':
                    let __lastimedzx = (new Date - user.lastopen)
...
`.trim()
                    if (user.gardenboxs >= 9) {
                        user.gardenboxs -= 10
                        user.bibitmangga += lks * 1
                        user.bibitpisang += lkr * 1
                        user.bibitjeruk += lke * 1
                        user.bibitapel += lkd * 1
                        user.bibitanggur += lky * 1
                        user.lastopen = new Date * 1
            	...
            	case '100':
                  case 'crate':
                    let __lastimedzxy = (new Date - user.lastopen)
...
`.trim()
                    if (user.gardenboxs >= 99) {
                        user.gardenboxs -= 100
                        user.bibitmangga += lksb * 1
                        user.bibitpisang += lkrb * 1
                        user.bibitjeruk += lkeb * 1
                        user.bibitapel += lkdb * 1
                        user.bibitanggur += lkyb * 1
                        user.lastopen = new Date * 1
    			...
    			case '1000':
                 case 'crate':
                    let __lastimedzxk = (new Date - user.lastopen)
...
`.trim()
                    if (user.gardenboxs >= 999) {
                        user.gardenboxs -= 1000
                        user.bibitmangga += lksk * 1
                        user.bibitpisang += lkrk * 1
                        user.bibitjeruk += lkek * 1
                        user.bibitapel += lkdk * 1
                        user.bibitanggur += lkyk * 1
                        user.lastopen = new Date * 1
        ...
        case 'cupon':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimeki = (new Date - user.lastopen)
...
`.trim()*/
                ...
                break
                case '10':
                    let __lastimekise = (new Date - user.lastopen)
...
`.trim()*/
        ...
        case 'legendary':
            switch (jumlah) {
                case '1':
                case 'crate':
                    let __lastimel = (new Date - user.lastopen)
...
`.trim()  
                ...
                break
                case '10':
                    let __lastimele = (new Date - user.lastopen)
...
`.trim()  
                ...
                break
                case '100':
                    let __lastimelee = (new Date - user.lastopen)
...
`.trim()  
                ...
                break
                case '1000':
                    let __lastimeleee = (new Date - user.lastopen)
...
`.trim()  
        ...
        case 'pet':
            ...
            let __lastimepet = (new Date - user.lastopen)
