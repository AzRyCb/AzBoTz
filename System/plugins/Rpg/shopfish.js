...
`.trim()
        ...
        if (/shopfish/i.test(command)) {
            ...
            case 'buy':
                switch (_type) {
                    case 'hiu':
                            if (user.money >= Bhiu * count) {
                                user.hiu += count * 1
                                user.money -= Bhiu * count
                    ...
                    break
                    case 'ikan':
                            if (user.money >= Bikan * count) {
                                user.ikan += count * 1
                                user.money -= Bikan * count
                    ...
                    break
                    case 'dory':
                            if (user.money >= Bdory * count) {
                                user.dory += count * 1
                                user.money -= Bdory * count
                    ...
                    break
                    case 'orca':
                            if (user.money >= Borca * count) {
                                user.orca += count * 1
                                user.money -= Borca * count
                    ...
                    break
                    case 'paus':
                            if (user.money >= Bpaus * count) {
                                user.paus += count * 1
                                user.money -= Bpaus * count
                    ...
                    break
                    case 'cumi':
                            if (user.money >= Bcumi * count) {
                                user.cumi += count * 1
                                user.money -= Bcumi * count
                    ...
                    break
                    case 'gurita':
                            if (user.money >= Bgurita * count) {
                                user.gurita += count * 1
                                user.money -= Bgurita * count
                    ...
                    break
                    case 'buntal':
                            if (user.money >= Bbuntal * count) {
                                user.buntal += count * 1
                                user.money -= Bbuntal * count
                    ...
                    break
                    case 'udang':
                            if (user.money >= Budang * count) {
                                user.udang += count * 1
                                user.money -= Budang * count
                    ...
                    break
                    case 'lumba':
                            if (user.money >= Blumba * count) {
                                user.lumba += count * 1
                                user.money -= Blumba * count
                    ...
                    break
                    case 'lobster':
                            if (user.money >= Blobster * count) {
                                user.lobster += count * 1
                                user.money -= Blobster * count
                    ...
                    break
                    case 'kepiting':
                            if (user.money >= Bkepiting * count) {
                                user.kepiting += count * 1
                                user.money -= Bkepiting * count
