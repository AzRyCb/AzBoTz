...
handler.all = async function (m) {
	...
	if (mf && (m.text === 'Balas Pesan' || m.text === '') && m.quoted?.mtype == 'buttonsMessage') return this.reply(m.chat, "Silahkan kirim pesan balasan kamu.")
	...
	await this.reply(mf.dari, txt, null).then(() => {
		this.reply(m.chat, 'Berhasil mengirim balasan.')
		delay(2000)
