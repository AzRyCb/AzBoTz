...
conn, usedPrefix, text, participants, groupMetadata
    ...
    if (user.stamina < 20) return conn.reply(m.chat, `Stamina anda tidak cukup\nharap isi stamina anda dengan *${usedPrefix}eat8`)
    if (user.lastngocok > 10800000) throw conn.reply(m.chat, `Kamu masih kelelahan\nHarap tunggu ${timers} lagi`)
...
setTimeout(() => {
    conn.sendButton(m.chat, hsl, set.wm, null, [['Inventory', '/inv']], m, { mentions: conn.parseMention(hsl) })
                     }, 27000) 
               
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, jln4, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                      }, 25000)
                
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, jln3, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 20000) 
                        
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, jln2, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 15000) 
                    
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, jln, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 10000) 
                     
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, `🔍 ${pengocok} Mencari Area ngocok.....`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 0) 
