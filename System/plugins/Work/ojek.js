...
let handler = async (m, { conn }) => {
    ...
    if (user.lastngojek > 10800000) throw conn.reply(m.chat, `Kamu masih kelelahan\nHarap tunggu ${timers} lagi`)
...
setTimeout(() => {
      ...
      [null, null]
                     ...
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, dimas4, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                      }, 25000)
                
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, dimas3, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 20000) 
                        
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, dimas2, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 15000) 
                    
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, dimas, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 10000) 
                     
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, `🔍 ${name} Mencari pelanggan.....`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 0) 
