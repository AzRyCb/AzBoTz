...
conn.level = db.data.users[m.sender]
  ...
  conn.reply(m.chat, `*Pet Kamu* (🦊kyubi ${db.data.users[m.sender].kyubi}) ⚔️menantang 🦊kyubinya *${conn.getName(lawan)}* (🦊kyubi ${db.data.users[lawan].kyubi}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`)
...
handler.help = handler.command = ['fightkyubi']
handler.tags = ['work']
