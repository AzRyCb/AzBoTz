...
conn.level = db.data.users[m.sender]
  ...
  conn.reply(m.chat, `*Pet Kamu* (🐉naga ${db.data.users[m.sender].naga}) ⚔️menantang 🐉naganya *${conn.getName(lawan)}* (🐉naga ${db.data.users[lawan].naga}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`)
...
handler.help = handler.command = ['fightnaga']
handler.tags = ['work']
