...
conn.level = db.data.users[m.sender]
  ...
  conn.reply(m.chat, `*Pet Kamu* (🦅phonix ${db.data.users[m.sender].phonix}) ⚔️menantang 🦅phonixnya *${conn.getName(lawan)}* (🦅phonix ${db.data.users[lawan].phonix}) lagi berkelahi.\n\nTunggu ${lamaPertarungan} menit lagi dan lihat siapa yg menang🎮.`)
...
handler.help = handler.command = ['fightphonix']
handler.tags = ['work']
