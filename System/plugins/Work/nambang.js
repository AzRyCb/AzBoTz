...
conn, usedPrefix
    ...
    if (user.lastnambang > 10800000) throw conn.reply(m.chat, `Kamu masih kelelahan\nHarap tunggu ${timers} lagi`)
...
setTimeout(() => {
                     conn.sendButton(m.chat, hsl, set.wm, null, [
		['Inventory', '/inv']
	], m)
                     }, 27000) 
      ...
      [null, null]
                     ...
                     setTimeout(() => {
                     conn.sendHydrated(m.chat, `🔍 ${penambang} Mencari Area Nambang.....`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                     }, 0) 
