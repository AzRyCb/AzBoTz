...
const timeout = 1800000
      ...
      [null, null]
                                  ...
                                  } else conn.reply(m.chat,`Pastikan bibit anggur kamu *500* untuk bisa berkebon`)
                              } else conn.reply(m.chat,`Pastikan bibit jeruk kamu *500* untuk bisa berkebon`)
                          } else conn.reply(m.chat,`Pastikan bibit pisang kamu *500* untuk bisa berkebon`)
                      } else conn.reply(m.chat,`Pastikan bibit apel kamu *500* untuk bisa berkebon`)
                  } else conn.reply(m.chat,`Pastikan bibit mangga kamu *500* untuk bisa berkebon`)
              }
handler.help = handler.command = ['berkebon']
handler.tags = ['work']
