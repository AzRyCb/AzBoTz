...
let handler  = async (m, { conn, command, args, usedPrefix }) => {
       ...
       const sections = [
    {
	title: set.htjava + ' List Contruction For Fishing ' + set.htjava,
	rows: [
...
//
	...
	let __timers = (new Date - pengguna.lastfishing)
        ...
        if (pengguna.stamina < 20) return conn.reply(m.chat, `Stamina anda tidak cukup\nharap isi stamina anda dengan *${usedPrefix}eat8`)
    if (pengguna.lastfishing > 10800000) throw conn.reply(m.chat, `Kamu masih kelelahan\nHarap tunggu *${timers}* lagi`)
...
${ usedPrefix }cook`    
        setTimeout(() => {
        conn.sendHydrated(m.chat, mcng, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
         if (psepick > 0 ) {
         	pengguna.psepick += psepick * 1
         conn.sendButton( m.chat, `You Get 🎁chest weapons epic ${psepick} item`, set.wm, [[`again`, `.mancing`]], m)
         } 
        if  (psenjata > 0 ) {
        	pengguna.psenjata+= psenjata * 1
        conn.sendButton( m.chat, `You Get 🎁chest weapons ${psenjata} item`, set.wm, [[`Again`, `.mancing`]], m)
        	}
        }, 38000)

        setTimeout(() => {
                     conn.sendHydrated(m.chat, `${pemancing} Sepertinya dapat sesuatu..`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                      }, 28000)
       setTimeout(() => {
                     conn.sendHydrated(m.chat, `${pemancing} Menunggu`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                      }, 8000)
       setTimeout(() => {
                     conn.sendHydrated(m.chat, `${pemancing} Sedang Memancing...`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                      }, 0)
        ...
        pengguna.nila += nila * 1
         ...
         pengguna.kepiting += kepiting * 1
        	  ...
        	  } else conn.reply(m.chat, `You're already fishing, wait until ${timers}`)
           } else return conn.sendButton(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, set.wm, [[`Buy Pancingan`, '.buy pancingan 1'], [`Buy Umpan 100`, '.buy umpan 100']], m)
           break
	          ...
	          case 'easy':
                                  ...
                                  if (pancingan == 0 || umpan == 0) return conn.sendButton(m.chat, `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`, set.wm, [[`Buy Pancingan`, '.buy pancingan 1'], [`Buy Umpan 100`, '.buy umpan 100']], m)
                                 ...
                                 let hsl = `
*${set.htjava} Hasil Memancing ${pemancing} ${set.htjava}*
 *🦀 = [ ${zero2} ]*			*🐠 = [ ${zero6} ]*
 *🦞 = [ ${zero8} ]*			 *🐟 = [ ${zero11} ]*
 *🦐 = [ ${zero10} ]*			 *🐬 = [ ${zero7} ]*
 *🦑 = [ ${zero4} ]*			 *🐳 = [ ${zero12} ]*
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, `${pemancing} Yuk mancing mania level easy lagi`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 28800000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, `${pemancing} Yuk mancing mania level normal lagi`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, hsls, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 12000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, `${pemancing} Yuk mancing mania level hard lagi`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, hslsh, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 12000) 
                                setTimeout(() => {
...
`.trim()
                                ...
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, `${pemancing} Yuk mancing mania level extreme lagi`, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 28800000) 
                                setTimeout(() => {
                                conn.sendHydrated(m.chat, hslse, set.botdate, null, null, null, null, null, [
      [null, null]
    ], null)
                                }, 12000) 
                                setTimeout(() => {
