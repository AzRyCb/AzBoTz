...
case 'ussop':
        ...
        let ad = ac.result.list
            conn.sendButtonImg(m.chat, ad, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'sadcat':
        ...
        let cd = cc.result.list
            conn.sendButtonImg(m.chat, cd, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'transformer':
        ...
        let fd = fc.result
            conn.sendButtonImg(m.chat, fd, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'wallrandom':
        ...
        let gd = gc.list.gambar
            conn.sendButtonImg(m.chat, gd, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'uncover':
  ...
  if (/webp/g.test(b_)) d_ = await webp2png(c_)
        ...
        conn.sendButtonImg(m.chat, wnt, wm, 'Nih.jpg', 'VIDEO', '.get ' + Gd.video, fakes, adReply)
            break
