...
conn.sendButton(m.chat, bbi, wm, bb, [['Menu', '/menu']], m, adReply)
            break
  ...
  let e__d = new Sticker(c__d, { pack: set.packname, author: set.author, type: StickerTypes.FULL })
  let d__d
  try {
  if (/webp/g.test(b__d)) d__d = await webp2png(c__d)
        ...
        conn.sendButtonImg(m.chat, cc, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'water':
        ...
        conn.sendButtonImg(m.chat, dd, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
let a__c = m.quoted ? m.quoted : m
  ...
  let e__c = new Sticker(c__c, { pack: set.packname, author: set.author, type: StickerTypes.FULL })
  let d__c
  try {
  if (/webp/g.test(b__c)) d__c = await webp2png(c__c)
        ...
        conn.sendButtonImg(m.chat, ee, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'waterwriting':
        ...
        conn.sendButtonImg(m.chat, ff, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
let a__b = m.quoted ? m.quoted : m
  ...
  let e__b = new Sticker(c__b, { pack: set.packname, author: set.author, type: StickerTypes.FULL })
  let d__b
  try {
  if (/webp/g.test(b__b)) d__b = await webp2png(c__b)
        ...
        conn.sendButtonImg(m.chat, gg, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
let a__a = m.quoted ? m.quoted : m
  ...
  let e__a = new Sticker(c__a, { pack: set.packname, author: set.author, type: StickerTypes.FULL })
  let d__a
  try {
  if (/webp/g.test(b__a)) d__a = await webp2png(c__a)
        ...
        conn.sendButtonImg(m.chat, hh, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'smoke':
        ...
        conn.sendButtonImg(m.chat, ii,wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'videogame':
        ...
        conn.sendButtonImg(m.chat, jj, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
}
}
} catch (e) {
