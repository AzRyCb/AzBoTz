...
let handler = async (m, { conn, command, usedPrefix }) => {
    ...
    if (id in conn.tebaksiapa) {
        conn.sendButton(m.chat, 'Masih ada soal belum terjawab di chat ini', set.wm, null, buttons, conn.tebaksiapa[id][0], fakes, adReply)
        throw false
    }
...
Bonus: ${poin} XP
    ...
    conn.tebaksiapa[id] = [
        ...
        setTimeout(() => {
            ...
            ], conn.tebaksiapa[id][0], fakes, adReply)
