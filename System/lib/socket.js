...
item1.TEL;waid=${number}:${PhoneNumber('+' + number), { regionCode: 'international' }}
...
let msg, file, jpg, thum, title, body, desc, media, source, type, render, ads, expi, men, thumUrl = 'https://telegra.ph?id=' + (Math.random(1234567890987654321) * 1234567890987654321)
if (options) {
thum = options.thum || options.thumb || options.thumbnail || null
title = options.title || null
body = options.body || null
desc = options.desc || null
media = options.med || options.media || null
source = options.sourc || options.source || null
type = options.type || options.medType || null
men = options.mention || options.mentions || options.contextInfo?.mentionedJid || null
render = options.render || options.larger || options.large || options.largerThumb|| null
ads = options.ads || options.iklan || null
expi = options.ephe || options.ephemeral || options.expi || options.expiration || null
if (thum) {
file = await conn.getFile(thum)
thum = await file.toBuffer()
}
if (render && thum) {
msg = { 
text, 
...
...options 		 
		...
		if (!(render && thum || media && Func.isUrl(media))) {
msg = { 
text, 
contextInfo: {
mentionedJid: Array.isArray(men) ? men : [men], 
            ...
            */
            ...
            async value(jid, button, rows, quoted, options = {}) {
                ...
                conn.sendMessage(jid, listMessage, {
                    ...
                    ephemeralExpiration: ephemeral,
                    contextInfo: {
                        forwardingScore: global.set.fsizedoc,
                        isForwarded: true,
...
*/
            ...
            */
            ...
            async value(jid, content, footerText, button1, id1, quoted, options) {
              ...
              const buttonMessage = {
                document: { url: "https://wa.me/" + global.set.nomorown },
                mimetype: global.set.doc,
                fileName: global.set.ucapan,
                fileLength: global.set.fsizedoc,
                pageCount: global.set.fpagedoc,
                    jpegThumbnail: global.set.tumhiho,
                caption: content,
                footer: footerText,
            ...
            */
            ...
            async value(jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
                ...
                const buttons = [
                    { index: 1, urlButton: { displayText: global.set.htjava + 'ɢɪᴛʜᴜʙ', url: global.set.gh } },
            ...
            async value(jid, buffer, content, footerText, button1, id1, quoted, options) {
                const buttons = [
                    { index: 1, urlButton: { displayText: global.set.htjava + 'ɢɪᴛʜᴜʙ', url: global.set.gh } },
                    { index: 2, callButton: { displayText: global.set.htjava + 'ᴏᴡɴᴇʀ',  phoneNumber: global.set.nomorown } },
