...
N:;${name.replace(/\n/g, '\\n')};;;
FN:${name.replace(/\n/g, '\\n')}
TEL;type=CELL;type=VOICE;waid=${number}:${parsePhoneNumber('+' + number), { regionCode: 'international'}}${biz.description ? `  
...
END:VCARD`.trim()
    ...
    async value(jid, path, quoted, options = {}){
        ...
        let buffer
        if (options && (options.packname || options.set.author)) {
    ...
    async value(jid, content, footerText, button1, id1, quoted, options) {
      ...
      const buttonMessage = {
        document: { url: "https://wa.me/" + set.nomorown },
        mimetype: set.doc,
        fileName: set.ucapan,
      ...
      conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.set.ephemeral, forwardingScore: set.fsizedoc, isForwarded: true, ...options })
    }},
    /** This Section **/
    send2ButtonDoc: {
    async value(jid, content, footerText, button1, id1, button2, id2, quoted, options) {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.set.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true }, ...options, ephemeralExpiration: ephemeral } )
    }},
    /** This Section **/
    send2ButtonImgDoc: {
    async value(jid, buffer, contentText, footerText, button1, id1, button2, id2, quoted, options) {
        ...
        return conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentionedJid: conn.parseMention(contentText + footerText) }, ...options })
    }},
    /** This Section **/
    send1Button: {
    async value(jid, content, footerText, button1, id1, quoted, options) {
        ...
        const buttonMessage = {
            ...
            footer: footerText,
            mentions: await conn.parseMention(content + footerText),
            ephemeralExpiration: set.ephemeral,
            ...options,
            buttons: buttons,
            headerType: 1
        }
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    send2Button: {
    async value(jid, content, footerText, button1, id1, button2, id2, quoted, options) {
    ...
    async value(jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    /**
     * send Button Loc
    ...
    */
    ...
    async value(jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        ...
        const buttons = [
            { index: 1, urlButton: { displayText: set.htjava + 'ɢɪᴛʜᴜʙ', url: set.gh } },
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true }, ...options, ephemeralExpiration: set.ephemeral } )
    }},
    /** This Section **/
    ...
    async value(jid, buffer, content, footerText, button1, id1, quoted, options) {
        const buttons = [
            { index: 1, urlButton: { displayText: set.htjava + 'ɢɪᴛʜᴜʙ', url: set.gh } },
            { index: 2, callButton: { displayText: set.htjava + 'ᴏᴡɴᴇʀ',  parsePhoneNumber: set.nomorown } },
        ...
        conn.sendMessage(jid, buttonMessage, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentionedJid: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true }, ...options, ephemeralExpiration: ephemeral } )
    }},
    /** This Section **/
    ...
    }), { userJid: conn.user.jid, quoted: quoted, contextInfo: { mentionedJid: conn.parseMention(contentText + footer) }, ephemeralExpiration: set.ephemeral, ...options });
    ...
    async value(jid, buffer, content, footerText, btn1, id1, options) {
        ...
        conn.sendMessage(jid, key, { ephemeralExpiration: set.ephemeral, mentions: conn.parseMention(content + footerText), contextInfo: { forwardingScore: set.fsizedoc, isForwarded: true }, ...options })
    }},
    /** This Section **/
    ...
    async value(jid, buffer, content, footerText, btn1, id1, btn2, id2, quoted, options) {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { mentions: conn.parseMention(content + footerText), forwardingScore: set.fsizedoc, isForwarded: true } })
    }},
    /** This Section **/
    ...
    async value(jid, buffer, content, footerText, btn1, id1, btn2, id2, btn3, id3, quoted, options) {
        ...
        conn.sendMessage(jid, key, { quoted, ephemeralExpiration: set.ephemeral, contextInfo: { forwardingScore: set.fsizedoc, isForwarded: true, mentions: conn.parseMention(content) } })
    }},
    /** Resize Image
      *
    ...
    */
    translate: {
        async value(code, text) {
            ...
            let translate2 = require('translate-google')
        ...
        */
        ...
        reply: {
            ...
            value(jid, text = '', quoted, options) {
                ...
                const u = set.clockString(_uptime)
                        ...
                        call.map((v, i) => [v, callText[i]])
                            .map(([call, callText], i) => ({
                                ...
                                callButton: {
                                    ...
                                    parsePhoneNumber: !nullish(call) && call || !nullish(callText) && callText || ''
                                }
                            })) || []
                    ))
                }
     ...
     sendListM: {
        async value(jid, button, rows, quoted, options = {}) {
            ...
            conn.sendMessage(jid, listMessage, {
                quoted,
                ephemeralExpiration: set.fsizedoc,
                contextInfo: {
        ...
        getName: {
            ...
            value(jid = '', withoutContact = false) {
                ...
                if (jid.endsWith('@g.us')) return (async () => {
                    ...
                    return (v.name || v.subject || parsePhoneNumber('+' + jid.replace('@s.whatsapp.net', '')), { regionCode: 'international' })
                })()
                ...
                return (withoutContact ? '' : v.name) || v.subject || v.vname || v.notify || v.verifiedName || parsePhoneNumber('+' + jid.replace('@s.whatsapp.net', '')), { regionCode: 'international' };  
            },
            enumerable: true,
            writable: true,
        },
