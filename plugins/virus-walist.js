...
const sections = [
   {
    title: `✃ INFO`,
	rows: [
	    {title: "🔮WhatsApp Imune 1", rowId: '.waimune1', description: 'Harap gunakan dengan bijak' },
	    {title: "🔮WhatsApp Imune 2", rowId: '.waimune2', description: 'Harap gunakan dengan bijak' },
	{title: "🔮WhatsApp Gb Kebal 1", rowId: '.wagb1', description: 'Harap gunakan dengan bijak' },
