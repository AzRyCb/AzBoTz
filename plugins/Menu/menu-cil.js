...
try {
	if(command) {
			switch(template) {
				...
				case 'texttopng':
					...
					try {
						let ttb = await sticker(null, ttx, set.packname, set.author)
  ...
  let e__ = new Sticker(c__, { pack: set.packname, author: set.author, type: StickerTypes.FULL })
  let d__
  try {
...
${gd.cerita}
				...
				case 'gsmarena':
					...
					return conn.sendList(m.chat, htki + ' 📺 Search 🔎 ' + htka, `⚡ Silakan pilih Search di tombol di bawah...\n*Teks yang anda kirim:* ${text}\n\nKetik ulang *${usedPrefix + command}* teks anda untuk mengubah teks lagi`, set.author, `☂️ Search Disini ☂️`, lesgom, m)
					break
				case 'grupwa':
					...
					return conn.sendList(m.chat, htki + ' 📺 Search 🔎 ' + htka, `⚡ Silakan pilih Search di tombol di bawah...\n*Teks yang anda kirim:* ${text}\n\nKetik ulang *${usedPrefix + command}* teks anda untuk mengubah teks lagi`, set.author, `☂️ Search Disini ☂️`, lesgox, m)
					break
				case 'ssticker':
					...
					return conn.sendList(m.chat, htki + ' 📺 Search 🔎 ' + htka, `⚡ Silakan pilih Search di tombol di bawah...`, set.author, `☂️ Search Disini ☂️`, lesgoz, m)
					break
				case 'hadits':
