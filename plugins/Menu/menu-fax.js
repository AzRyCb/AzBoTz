...
case 'biden':
	...
	return await conn.sendListM(m.chat, df, de, m)
        ...
        conn.sendButtonImg(m.chat, fc.result, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
case 'yuri':
        ...
        conn.sendButtonImg(m.chat, gc.result, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
...
let hb = 'https://fax-home.herokuapp.com/api/photooxy/' + args[0] + '?text=' + one + '&apikey=921a7l9pho2'
        conn.sendButtonImg(m.chat, hb, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
            
            case 'coffee':
            case 'dadu':
let ib = 'https://fax-home.herokuapp.com/api/random/' + args[0] + '?apikey=921a7l9pho2'
        conn.sendButtonImg(m.chat, ib, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
            
            case 'couplepp':
let jb = await fetch('https://fax-home.herokuapp.com/api/random/couplepp?apikey=921a7l9pho2')
let jc = await jb.json()
        conn.sendButtonImg(m.chat, jc.result.female, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            conn.sendButtonImg(m.chat, jc.result.male, wm, 'Nih.jpg', 'To Sticker', '.s', fakes, adReply)
            break
