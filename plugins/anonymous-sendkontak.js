...
➔ Nama: ${name}`
	...
	if (other) this.sendHydrated(other, `––––––『 ᴀɴᴏɴʏᴍᴏᴜs ᴄʜᴀᴛs 』––––––`, tks, await conn.profilePictureUrl(m.sender, 'image').catch(_ => './thumbnail.jpg'), `wa.me/${m.sender.split`@`[0]}`, 'ᴛᴜʀɴ ᴄʜᴀᴛ ᴘᴀʀᴛɴᴇʀ', null,null, [['ʟᴇᴀᴠᴇ', '.leave'],[null,null],[null,null]], 0,  { mentionedJid: [m.sender]})
}
